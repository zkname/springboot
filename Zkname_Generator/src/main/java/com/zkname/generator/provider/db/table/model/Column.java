package com.zkname.generator.provider.db.table.model;



import java.util.List;

import com.zkname.generator.GeneratorProperties;
import com.zkname.generator.provider.db.table.model.ForeignKey.ReferenceKey;
import com.zkname.generator.provider.db.table.model.util.ColumnHelper;
import com.zkname.generator.util.GLogger;
import com.zkname.generator.util.StringHelper;
import com.zkname.generator.util.TestDataGenerator;
import com.zkname.generator.util.typemapping.ActionScriptDataTypesUtils;
import com.zkname.generator.util.typemapping.DatabaseDataTypesUtils;
import com.zkname.generator.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable,Cloneable{
	...
	public Column(Table table, int sqlType, String sqlTypeName,
			...
			String defaultValue,String remarks,boolean isAuto) {
