...
public class Table implements java.io.Serializable,Cloneable {
	...
	public String getSeqName() {
		return "SEQ_"+sqlName.substring(sqlName.indexOf("_")+1);
	}
	 ...
	 * @since  1.0.0
	 */
	public String getBeginToLowerCaseClassName() {
	...
	public String getToLowerCaseClassName() {
		String className = getClassName();
		StringBuffer sb = new StringBuffer();
		for(int i=0;i<className.length();i++){
			sb.append(Character.toLowerCase(className.charAt(i)));
