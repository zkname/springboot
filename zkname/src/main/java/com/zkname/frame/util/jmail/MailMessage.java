package com.zkname.frame.util.jmail;
...
import com.zkname.frame.util.jmail.exception.MailException;
...
public class MailMessage {
	...
	public MailMessage from(String from) {
		Assert.notEmpty(new Object[]{from}, "from mail not is empty!");
		this.from = from;
		return this;
	}
	
	public MailMessage from(String nickName, String from) {
		Assert.notEmpty(new Object[]{nickName}, "nick name not is empty!");
		Assert.notEmpty(new Object[]{from}, "from mail not is empty!");
	...
	public MailMessage addTo(String to) {
		Assert.notEmpty(new Object[]{to}, "to mail not is empty!");
		this.toList.add(to);
		return this;
	}
	...
	public MailMessage addCC(String cc) {
		Assert.notEmpty(new Object[]{cc}, "cc mail not is empty!");
		this.ccList.add(cc);
		return this;
	}
	...
	public MailMessage subject(String subject) {
		Assert.notEmpty(new Object[]{subject}, "subject mail not is empty!");
	...
	public MailMessage content(String content) {
		Assert.notEmpty(new Object[]{content}, "mail content not is empty!");
		this.content = content;
		return this;
	}
	
	public MailMessage addFile(String filePath) {
		Assert.notEmpty(new Object[]{filePath}, "filePath not is empty!");
