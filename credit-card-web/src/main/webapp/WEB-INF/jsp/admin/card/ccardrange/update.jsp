...
<form action="${ctx}/admin/card/ccardrange/updateInput" method="POST" id="inputForm">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				...
      				<input value="${entity.moneyPropStartValue}" id="moneyPropStartValue" name="moneyPropStartValue" class="required validate-integer min-value-5 max-value-80 form-control"  />
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                  	<div class="input-group">
      				<input value="${entity.moneyPropEndValue}" id="moneyPropEndValue" name="moneyPropEndValue" class="required validate-integer min-value-5 max-value-80 form-control"  />
      				<span class="input-group-addon">%</span>
      				</div>
      				<br>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				<input value="${entity.frequencyPropStartValue}" id="frequencyPropStartValue" name="frequencyPropStartValue" class="required validate-integer min-value-5 max-value-30 form-control"  />
      				<br>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				<input value="${entity.frequencyPropEndtValue}" id="frequencyPropEndtValue" name="frequencyPropEndtValue" class="required validate-integer min-value-5 max-value-35 form-control"  />
      				<br>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				<input value="${entity.billGapDay}" id="billGapDay" name="billGapDay" class="required validate-integer min-value-0 max-value-31 form-control"  />
      				<br>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				<input value="${entity.day}" id="day" name="day" class="required validate-integer min-value-5 max-value-31 form-control"  />
      				<br>
                  </div>
                </div>
                <div class="form-group">
