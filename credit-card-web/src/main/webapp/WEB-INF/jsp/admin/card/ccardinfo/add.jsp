...
<form action="${ctx}/admin/card/ccardinfo/addInput" method="POST" id="inputForm">
            ...
            <!-- /.box-header -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
      				<input value="${entity.nextUp}" id="nextUp" name="nextUp" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" class=" form-control" />
      				<br>
                  </div>
                </div>
                <div class="form-group">
