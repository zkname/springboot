...
<form action="${ctx}/admin/card/cbank/updateInput" method="POST" id="inputForm">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"> 银行信息编辑</h3>
            </div>
            <!-- /.box-header -->
              <div class="box-body">
                <div class="form-group">
                  <label class="col-sm-2 control-label"><%=Cbank.ALIAS_NAME%></label>
                  <div class="col-sm-10">
      				<input value="${entity.name}" id="name" name="name" class=" form-control"  />
      				<br>
                  </div>
                </div>
              </div>
