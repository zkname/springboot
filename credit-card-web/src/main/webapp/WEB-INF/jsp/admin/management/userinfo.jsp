            ...
            <!-- /.box-header -->
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control max-length-20" id="realName" name="realName" value="${user.realName}" >
                  <br></div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control required validate-email max-length-50" id="email" name="email" value="${user.email}">
                  <br></div>
                </div>
              </div>
              <!-- /.box-body -->
