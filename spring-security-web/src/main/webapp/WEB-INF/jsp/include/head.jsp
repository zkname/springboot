...
<title>DEMO管理平台</title>
<!-- jQuery 3 -->
<script src="${ctx}/bower_components/jquery/dist/jquery.min.js"></script>
<!--  validation -->
<link href="${ctx}/js/rapid-validation/style_min.css" rel="stylesheet" type="text/css" />
<script src="${ctx}/js/rapid-validation/validation_cn.js" type="text/javascript"></script>
...
<!-- Font Awesome -->
<link rel="stylesheet" href="${ctx}/bower_components/font-awesome/css/font-awesome.min.css">
<!-- Theme style -->
