...
public class XMemcachedClientImp implements XMemcacheClient{
	...
	public XMemcachedClientImp(String namespace,MemcachedClient memcachedClient){
		this.namespace=namespace;
		this.memcachedClient=memcachedClient;
		logger.debug("Initializing namespace{} , {}",namespace,this.getClass().getCanonicalName());
	}
